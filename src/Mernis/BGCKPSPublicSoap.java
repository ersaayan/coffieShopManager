...
public class BGCKPSPublicSoap
{
    ...
    public BGCKPSPublicSoap(){}

    public BGCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BGCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BGCExtendedSoapSerializationEnvelope envelope= new BGCExtendedSoapSerializationEnvelope(BGCExtendedSoapSerializationEnvelope.VER11);
