...
public class BGCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BGCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BGCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BGCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BGCDateTimeConverter dateTimeConverter = new BGCStandardDateTimeConverter();

    public BGCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BGCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BGCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BGCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BGCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BGCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
